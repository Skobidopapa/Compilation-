...
// Clone all the images and append them to the wrapper
bannerCards.forEach(card => {
  const clone = card.cloneNode(true); // Clone each image card
  bannerWrapper.appendChild(clone); // Append the clone to the wrapper
});